...
GithubException(403, {'message': 'Resource not accessible by personal access token', 'documentation_url': 'https://docs.github.com/rest/repos/contents#create-or-update-file-contents'}, {'server': 'GitHub.com', 'date': 'Tue, 05 Dec 2023 14:32:19 GMT', 'content-type': 'application/json; charset=utf-8', 'transfer-encoding': 'chunked', 'github-authentication-token-expiration': '2024-12-05 00:00:00 +0800', 'x-github-media-type': 'github.v3; format=json', 'x-accepted-github-permissions': 'contents=write', 'x-github-api-version-selected': '2022-11-28', 'x-ratelimit-limit': '5000', 'x-ratelimit-remaining': '4884', 'x-ratelimit-reset': '1701790126', 'x-ratelimit-used': '116', 'x-ratelimit-resource': 'core', 'access-control-expose-headers': 'ETag, Link, Location, Retry


<!-- or(MaxRetryError("HTTPSConnectionPool(host='api.github.com', port=443): Max retries exceeded with url: /repos/TownFang/townfang.github.io/contents/source/_posts/%E6%B5%8B%E8%AF%95.md (Caused by SSLError(SSLEOFError(8, -->